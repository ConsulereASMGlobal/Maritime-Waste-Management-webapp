...
const RawMaterialTypeModalForm: FC<Props> = ({user = {}, isUserLoading}) => {
          ...
          <div className='fv-row mb-7'>
            ...
            <input
              ...
              className={clsx(
                ...
                {
                  'is-valid': formik.touched.category && !formik.errors.processName,
                }
              )}
              autoComplete='off'
...
export default RawMaterialTypeModalForm
