...
const QualityList = () => {
  ...
  return (
    <KTCard>
      ...
      <UserEditModal formName='ProcessingRouteModallForm' />
    </KTCard>
  )
}

const ProcessingRoutesWrapper = () => (
  // <QueryRequestProvider initialValue={{enabled: false}}>
  <QueryRequestProvider initialValue={{initialApi: 'materialProcesses'}}>
...
export {ProcessingRoutesWrapper}
