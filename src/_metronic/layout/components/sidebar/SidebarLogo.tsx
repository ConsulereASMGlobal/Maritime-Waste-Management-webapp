...
const SidebarLogo = (props: PropsType) => {
  ...
  return (
    <div className='app-sidebar-logo mx-auto' id='kt_app_sidebar_logo'>
      {/* {config.layoutType === 'dark-sidebar' ? (
        <div style={{color: 'white'}}>Admin App</div>
      ) : (
        <div className='text-color-white h-25px app-sidebar-logo-default theme-light-show'>
          Admin App
        </div>
      )} */}
      <Link to='/dashboard'>
